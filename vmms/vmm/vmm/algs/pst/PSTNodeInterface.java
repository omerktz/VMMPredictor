...
public interface PSTNodeInterface {
       ...
       double predict(IntSequence ch);

       //double predict(int b);
       double predict(int []bytes);
        ...
        *          by seq.
        */
       PSTNodeInterface get(int[] byteSeq);//descended
       PSTNodeInterface get(IntSequence seq);//descended
       PSTNodeInterface get(ContextIterator contextIter);//descended
       PSTNodeInterface get(int symbol);//child

       void insert(int symbol, double[] nextSymProbability);
