...
public interface VMMPredictor {
   ...
   */
  void learn(IntSequence trainingSequence);
   ...
   */
  double predict(int symbol, IntSequence context);
   ...
   * @throws VMMNotTrainedException when predicting without training
   */
  double logEval(IntSequence testSequence);
   ...
   * @throws VMMNotTrainedException when predicting without training
   */
  double logEval(IntSequence testSequence, IntSequence initialContext);
}
